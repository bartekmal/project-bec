...
set first_event=1
set num_events=20
set run_number=11357
set prod_name=MC_Pbp_MD_test

set walltime=03-00:00:00

#set top_dir_sim="/eos/lhcb/user/b/bmalecki/BEC_pPb/dst/EPOS"
set top_dir_sim="/mnt/lustre/scratch2/people/plgbmalecki/BEC_pPb/HIJING/dst"
...
sbatch -p plgrid -t ${walltime}  -J ${prod_name}_${job} job_${job}.csh
