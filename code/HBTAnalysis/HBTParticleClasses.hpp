...
namespace HBT {
  ...
  class Particle {
    public:
      ...
      //constructor
      Particle( const int& part_i, const bool& isMC, const int& particlePIDCode, const HBT::Units::FloatType& particleMass) : 
        m_pvIndex( pvIndex[part_i] ),
  ...
  class ParticlePair {
    public:
      ...
      //constructor
      ParticlePair( const HBT::Particle& part1, const HBT::Particle& part2 ) : 
        m_pvIndexParticle1( part1.m_pvIndex ),
...
inline void HBT::ParticlePair::buildLAB( const HBT::Particle& part1, const HBT::Particle& part2 ){
  ...
  if ( m_deltaPhi_LAB > HBT::Units::Pi ) m_deltaPhi_LAB = HBT::Units::TwoPi - m_deltaPhi_LAB;
...
inline void HBT::ParticlePair::buildLCMS( const HBT::Particle& part1, const HBT::Particle& part2 ){
  ...
  if( m_deltaPhi_LCMS > HBT::Units::Pi ) m_deltaPhi_LCMS = HBT::Units::TwoPi - m_deltaPhi_LCMS;
