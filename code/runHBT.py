...
def runCorrFuncs(outputFolderName="corrFuncs"):
    ...
    # define jobs
    jobsToRun = [
        # just draw correlation functions (no fits)
        # DATA UNLIKE
        {
        ...
        # # show resonance removal
        # {
        #     'inputFile': os.getenv('MYDIR') + "/output/correlations_resonancesRemoved/RD_pPb/correlations.root",
        #     'hMainNameBase': "h4110",
        #     'hMainNameBase_1': "h3110",
        #     'hMainNameBase_2': "h3610",
        #     'isMC': "false",
        ...
        #     'inputFileRef': os.getenv('MYDIR') + "/output/correlations/RD_pPb/correlations.root",
        #     'hRefNameBase': "h4110",
        #     'refType': "#font[12]{p}Pb data (OS - no res)",
        #     'flagDrawRef': "true",
        #     'flagUseBkgFromRef': "false",
        #     'flagUseBkgScaling': "false",
        #     'ignoreBinMultLower': ignoreBinMultLower['pPb'],
        ...
        # },
        # {
        #     'inputFile': os.getenv('MYDIR') + "/output/correlations_resonancesRemoved/RD_Pbp/correlations.root",
        #     'hMainNameBase': "h4110",
        #     'hMainNameBase_1': "h3110",
        #     'hMainNameBase_2': "h3610",
        #     'isMC': "false",
        ...
        #     'inputFileRef': os.getenv('MYDIR') + "/output/correlations/RD_Pbp/correlations.root",
        #     'hRefNameBase': "h4110",
        #     'refType': "Pb#font[12]{p} data (OS - no res)",
        #     'flagDrawRef': "true",
        #     'flagUseBkgFromRef': "false",
        #     'flagUseBkgScaling': "false",
        #     'ignoreBinMultLower': ignoreBinMultLower['Pbp'],
