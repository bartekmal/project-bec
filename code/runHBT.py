...
histogramsToDraw = [
    ...
    # EVMIX control plots (mult, zPV distributions: LIKE vs EVMIX)
    {'name': 'h3002', 'refName': 'h3502', 'flagRefInput': 'same', 'nameEnd': '',
     'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    {'name': 'h3002_both', 'refName': 'h3502_both', 'flagRefInput': 'same', 'nameEnd': '',
     'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    {'name': 'h3004', 'refName': 'h3504', 'flagRefInput': 'same', 'nameEnd': '',
     'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    {'name': 'h3004_both', 'refName': 'h3504_both', 'flagRefInput': 'same', 'nameEnd': '',
     'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    {'name': 'h3002', 'refName': 'h3502', 'flagRefInput': 'same', 'nameEnd': '',
     'dim': '1D', 'type': 'normalised', 'flagBins': 0, 'isHistFullName': False},
    {'name': 'h3002_both', 'refName': 'h3502_both', 'flagRefInput': 'same', 'nameEnd': '',
    ...
    # {'name': 'h3002', 'refName': 'h3002', 'flagRefInput': 'custom', 'nameEnd': '',
    #  'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    # {'name': 'h3004', 'refName': 'h3004', 'flagRefInput': 'custom', 'nameEnd': '',
    #  'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    # {'name': 'h3010', 'refName': 'h3010', 'flagRefInput': 'custom', 'nameEnd': '_400',
    #  'dim': '1D', 'type': 'std', 'flagBins': 1, 'isHistFullName': False},
    # {'name': 'h3502', 'refName': 'h3502', 'flagRefInput': 'custom', 'nameEnd': '',
    #  'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    # {'name': 'h3504', 'refName': 'h3504', 'flagRefInput': 'custom', 'nameEnd': '',
    #  'dim': '1D', 'type': 'std', 'flagBins': 0, 'isHistFullName': False},
    # {'name': 'h3510', 'refName': 'h3510', 'flagRefInput': 'custom', 'nameEnd': '_400',
    #  'dim': '1D', 'type': 'std', 'flagBins': 1, 'isHistFullName': False},
        ...
        jobsToRun = [
            {
                ...
                'hMainName': hist['name'],
                'fileRefPath': (os.getenv('MYDIR') + "/output/merged/RD_pPb/merged.root") if flagRefInputSame else (os.getenv('BEC_BASE_ANALYSIS') + "/main/output/merged/RD_pPb/merged.root"),
            ...
            },
            {
                ...
                'hMainName': hist['name'],
                'fileRefPath': (os.getenv('MYDIR') + "/output/merged/RD_Pbp/merged.root") if flagRefInputSame else (os.getenv('BEC_BASE_ANALYSIS') + "/main/output/merged/RD_Pbp/merged.root"),
                'hRefName': hist['refName'],
