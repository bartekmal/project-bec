...
#BEC tracks
for trType in ['Pi','K','P','P_TotLc','Mu','e'] :
    # BEC, nie usuwamy niczego!
    AddBinScheme(trType, 'P', 'BEC_pPb', 2000, 100000)
    #AddBinBoundary(trType, 'P', 'BEC_pPb', 9300) # R1 Kaon threshold
    AddBinBoundary(trType, 'P', 'BEC_pPb', 15600) # R2 Kaon threshold
    AddUniformBins(trType, 'P', 'BEC_pPb', 10, 25000, 100000)
    AddBinScheme(trType, 'ETA', 'BEC_pPb', 1.5, 5)
    AddUniformBins(trType, 'ETA', 'BEC_pPb', 4, 1.5, 5)
    AddBinScheme(trType, 'nTracks', 'BEC_pPb', 5.0, 100)
    AddUniformBins(trType, 'nTracks', 'BEC_pPb', 4, 5, 100)

    # BEC, nie usuwamy niczego!
    AddBinScheme(trType, 'P', 'BEC_pPb_2', 2000, 100000)
    AddBinBoundary(trType, 'P', 'BEC_pPb_2', 9300) # R1 Kaon threshold
    AddBinBoundary(trType, 'P', 'BEC_pPb_2', 15600) # R2 Kaon threshold
    AddUniformBins(trType, 'P', 'BEC_pPb_2', 5, 25000, 100000)
    AddBinScheme(trType, 'ETA', 'BEC_pPb_2', 1.5, 5)
    AddUniformBins(trType, 'ETA', 'BEC_pPb_2', 4, 1.5, 5)
    AddBinScheme(trType, 'nTracks', 'BEC_pPb_2', 5.0, 100)
    AddUniformBins(trType, 'nTracks', 'BEC_pPb_2', 4, 5, 100)

    # BEC, nie usuwamy niczego!
    AddBinScheme(trType, 'P', 'BEC_Pbp', 2000, 100000)
    #AddBinBoundary(trType, 'P', 'BEC_Pbp', 9300) # R1 Kaon threshold
    AddBinBoundary(trType, 'P', 'BEC_Pbp', 15600) # R2 Kaon threshold
    AddUniformBins(trType, 'P', 'BEC_Pbp', 10, 25000, 100000)
    AddBinScheme(trType, 'ETA', 'BEC_Pbp', 1.5, 5)
    AddUniformBins(trType, 'ETA', 'BEC_Pbp', 4, 1.5, 5)
    AddBinScheme(trType, 'nTracks', 'BEC_Pbp', 5.0, 150)
    AddUniformBins(trType, 'nTracks', 'BEC_Pbp', 6, 5, 150)

    # BEC, nie usuwamy niczego!
    AddBinScheme(trType, 'P', 'BEC_Pbp_2', 2000, 100000)
    AddBinBoundary(trType, 'P', 'BEC_Pbp_2', 9300) # R1 Kaon threshold
    AddBinBoundary(trType, 'P', 'BEC_Pbp_2', 15600) # R2 Kaon threshold
    AddUniformBins(trType, 'P', 'BEC_Pbp_2', 5, 25000, 100000)
    AddBinScheme(trType, 'ETA', 'BEC_Pbp_2', 1.5, 5)
    AddUniformBins(trType, 'ETA', 'BEC_Pbp_2', 4, 1.5, 5)
    AddBinScheme(trType, 'nTracks', 'BEC_Pbp_2', 5.0, 100)
    AddUniformBins(trType, 'nTracks', 'BEC_Pbp_2', 6, 5, 150)
