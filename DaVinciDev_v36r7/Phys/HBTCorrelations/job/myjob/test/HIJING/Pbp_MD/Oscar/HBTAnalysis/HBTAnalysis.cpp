...
int main(int argc, char** argv) {
  ...
  if(!MC)
  {
    f1_name = TString("/mnt/nfs/storage/plgbmalecki/BEC_pPb/DaVinciDev_v36r7/Phys/HBTCorrelations/job/myjob/test/HIJING/Pbp_MD/Oscar/hbtNTuple.root");
    label = TString("basicVars");
  }else
  {
