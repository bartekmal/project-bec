...
void drawSame1(TString hName,TString f1Name,TString f2Name,TString f3Name,TString f4Name, TString title = "")
{
  ...
  Ltext->DrawLatex(commPosX,commPosY, TString("Pbp - MD"));
...
void drawSame()
{
  ...
  TString f1Name = TString("EPOS/output/Pbp_MD/basicVars_local.root");
  TString f2Name = TString("HIJING/Pbp_MD/Oscar/HBTAnalysis/basicVars.root");
  TString f3Name = TString("data/Pbp_MD/HBTAnalysis/basicVars.root");
  TString f4Name = TString("HIJING/Pbp_MD/HBTAnalysis/basicVars.root");
