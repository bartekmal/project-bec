...
cd ${BASE_BEC_PROD}/test/MC/Pbp

${BASE_BEC}/DaVinciDev_v36r7/run gaudirun.py ${BASE_BEC_PROD}/options/HBTCorrelations.py ${BASE_BEC_PROD}/options/MC_Pbp_MD.py ${BASE_BEC_PROD}/data/test_MC_ionproton.py > Pbp.log
