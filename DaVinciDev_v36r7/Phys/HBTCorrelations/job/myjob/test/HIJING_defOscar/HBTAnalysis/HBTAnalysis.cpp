...
int main(int argc, char** argv) {
  ...
  if(!MC)
  {
    f1_name = TString("/mnt/nfs/storage/plgbmalecki/BEC_pPb/DaVinciDev_v36r7/Phys/HBTCorrelations/job/myjob/test/HIJING_defOscar/hbtNTuple.root");
    label = TString("basicVars_local");
  }else
  {
    //f1_name = TString("/eos/lhcb/user/b/bmalecki/BEC_pPb/ntuple/MC_pPb_MU/hbtNTuple.root");
    //label = TString("basicVars_central");
  }
