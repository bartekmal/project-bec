...
appOpts = j.application.user_release_area + '/DaVinci_' + j.application.version + '/Phys/HBTCorrelations/job/'
j.application.optsfile = [ File ( appOpts+'HBTCorrelations_MC_md.py' ), File(appOpts+'minBias2011_MagDown_Pythia8.py') ]
# Extra options
